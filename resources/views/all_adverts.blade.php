...
@endif
              ...
              <h6 class="display-6">Admin / Adverts</h6>
              <div>
           <hr>
                </div>
              <div>
                <a style="margin: 19px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap">New Adverts</a>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="/store_advert" method="POST" enctype="multipart/form-data">
                          @csrf <!-- {{ csrf_field() }} -->
                          <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Advert slide text:</label>
                        <textarea class="form-control" name="name" id="" cols="30" rows="10"></textarea>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="exampleInputEmail1" class="form-label">Advert image</label>
   ...
   @endphp
      ...
      <tr>
        ...
        <td>  <img class="img-tec" style="height:60px; width:60px;" src="{{ asset('advert') }}/{!! $product['photo'] !!}" alt="">  </td>
        <td>{!! $product['name'] !!}</td>
